...
export default function ProjectDetailPage() {
  ...
  const amenities = locale === "ar"
    ? ['مسبح إنفينيتي معلق', 'نادي صحي ورياضي فاخر', 'خدمة صف السيارات', 'ردهة استقبال 5 نجوم', 'خدمة كونسيرج 24/7', 'مواقف خاصة للسيارات']
    : ['Infinity Suspended Pool', 'Ultra-Luxury Gym & Spa', 'Valet Parking', '5-Star Grand Lobby', '24/7 Concierge Service', 'Private Residents Parking'];
    ...
    <div className="bg-background min-h-screen text-foreground pb-24 transition-colors duration-300">
      ...
      <div className="relative h-[75vh] min-h-[550px] w-full overflow-hidden">
        ...
        >
          ...
          <img 
            src="https://images.unsplash.com/photo-1546412414-e1885259563a?q=80&w=2000&auto=format&fit=crop" 
            alt="Project" 
            ...
            <div className="flex flex-wrap gap-8 items-center border-t border-white/20 pt-6 mt-4">
              <div>
                ...
                <p className="text-2xl md:text-3xl font-bold text-accent">
                  {locale === 'ar' ? '9,500,000 درهم' : 'AED 9,500,000'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-2xl md:text-3xl font-light text-white">
                  {locale === 'ar' ? 'الربع الرابع 2027' : 'Q4 2027'}
                </p>
              </div>
          ...
          <div className="lg:col-span-2 space-y-16">
            <section>
              ...
              <p className="text-foreground/70 text-lg font-light leading-relaxed">
                {locale === 'ar'
                  ? 'برج أيقوني فائق الفخامة يرتفع 65 طابقاً في قلب وسط مدينة دبي بإطلالات مباشرة على برج خليفة ونافورة دبي. تم تصميمه بالتعاون مع كبرى بيوت التصميم الإيطالية لتقديم تجربة سكنية استثنائية.'
                  : 'An ultra-luxury architectural icon rising 65 storeys in the heart of Downtown Dubai with direct Burj Khalifa and Dubai Fountain views. Designed in collaboration with premier Italian design houses to deliver an unparalleled residential lifestyle.'
                }
              </p>
            </section>
